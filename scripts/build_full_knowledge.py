#!/usr/bin/env python3
"""
Builds scripts/layout_knowledge.py containing:
- NAMES_EN (350 layouts mapped to precise English names)
- SUBCATEGORY_PROFILES (33 subcategories with rich domain-specific design knowledge)
- compile_enriched_layout_data(item) -> full layout JSON dict
"""
...
TARGET_FILE = BASE_DIR / "scripts" / "layout_knowledge.py"

# Import NAMES_EN from generate_knowledge_module
from generate_knowledge_module import NAMES_EN
...
NAMES_EN = ''' + json.dumps(NAMES_EN, ensure_ascii=False, indent=2) + '''
...
print(f"✓ Generated {TARGET_FILE} with complete 350-name mapping & 33 subcategories.")
